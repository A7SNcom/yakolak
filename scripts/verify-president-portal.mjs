...
for(const token of["const API='./api/developer-president'","gates.reviewer==='PASS'","gates.manager==='PASS'","gates.hakam==='MERGE_OK'","gates.ci==='GREEN'","document.body.dataset.developerRole='president'"])if(!ui.includes(token))fail(`UI missing ${token}`);
