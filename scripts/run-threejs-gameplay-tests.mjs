...
export const GAMEPLAY_TEST_FILES = Object.freeze([
  ...
  'tests/gameprep_hud_pointer_passthrough.test.mjs',
  'tests/gameprep_rendered_hit_targets.test.mjs',
  'tests/gameprep_approved_intro_contract.test.mjs',
  ...
  'tests/threejs_board_cell_picking_contract.test.mjs',
  ...
  'tests/threejs_selected_piece_presentation_contract.test.mjs',
  'tests/threejs_last_move_marker_contract.test.mjs',
  'tests/threejs_action_feedback_contract.test.mjs',
  'tests/threejs_accepted_piece_travel_contract.test.mjs',
