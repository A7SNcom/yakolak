...
const branding = read('src/app-game-v130-brand.js');
...
const checks = [
  ...
  ['branding starts before room sequence', app.indexOf('app-game-v130-brand') < app.indexOf('app-game-v130.js')],
...
console.log('Build 130 approved-room branding continuity and v126 gameplay contracts passed.');
