...
for(const value of ['contractFor(','previewSourcesFor(','previewItemSelect','previewVersionSelect','@media(max-width:760px)','[hidden]{display:none!important}'])need(js+css,value);
