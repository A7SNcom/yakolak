...
test('PAGES-015 blocker documentation is receipt-driven and preserves the PAGES-014 resume trigger', () => {
...
test('PAGES-015 blocker documentation cannot promote diagnostics into qualification evidence', () => {
