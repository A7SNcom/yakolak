...
- PCLOCAL وThree.js وGitHub Pages وكل الفروع/المسارات القديمة تاريخ READ-ONLY فقط؛ لا تُستخدم كبناء أو نشر أو استرجاع أو fallback تنفيذي.
...
- لا تشغّل PCLOCAL أو Three.js أو GitHub Pages كبديل عند تعطل المسار المعتمد؛ أصلح مسار `main`/Flash نفسه.
