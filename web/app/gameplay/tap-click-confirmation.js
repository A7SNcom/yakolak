...
export function createTapClickConfirmationController({
  ...
  function tapBoard({
    ...
    // Lock pending BEFORE entering authority.submit. This closes re-entrant/rapid tap
    // duplication even if an adapter performs synchronous work before returning Promise.
